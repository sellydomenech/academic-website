...
class FillPermissionsForPasswordResetToken extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPasswordResetToken constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.password-reset-token.index',
            'admin.password-reset-token.create',
            'admin.password-reset-token.show',
            'admin.password-reset-token.edit',
            'admin.password-reset-token.delete',
            'admin.password-reset-token.bulk-delete',
        ]);
