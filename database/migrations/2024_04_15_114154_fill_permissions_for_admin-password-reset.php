...
class FillPermissionsForAdminPasswordReset extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAdminPasswordReset constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.admin-password-reset.index',
            'admin.admin-password-reset.create',
            'admin.admin-password-reset.show',
            'admin.admin-password-reset.edit',
            'admin.admin-password-reset.delete',
            'admin.admin-password-reset.bulk-delete',
        ]);
