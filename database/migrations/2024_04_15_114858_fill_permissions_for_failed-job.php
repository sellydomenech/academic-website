...
class FillPermissionsForFailedJob extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFailedJob constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.failed-job.create',
            'admin.failed-job.show',
            'admin.failed-job.edit',
            'admin.failed-job.delete',
            'admin.failed-job.bulk-delete',
        ]);
