...
class FillPermissionsForModelHasRole extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForModelHasRole constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.model-has-role',
            'admin.model-has-role.index',
            'admin.model-has-role.create',
            'admin.model-has-role.show',
            'admin.model-has-role.edit',
            'admin.model-has-role.delete',
            'admin.model-has-role.bulk-delete',
        ]);
