...
class FillPermissionsForAdminActivation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAdminActivation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.admin-activation.index',
            'admin.admin-activation.create',
            'admin.admin-activation.show',
            'admin.admin-activation.edit',
            'admin.admin-activation.delete',
            'admin.admin-activation.bulk-delete',
        ]);
