...
class FillPermissionsForClassHasSubject extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForClassHasSubject constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.class-has-subject',
            'admin.class-has-subject.index',
            'admin.class-has-subject.create',
            'admin.class-has-subject.show',
            'admin.class-has-subject.edit',
            'admin.class-has-subject.delete',
            'admin.class-has-subject.bulk-delete',
        ]);
