...
class FillPermissionsForStudentHasClass extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStudentHasClass constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.student-has-class',
            'admin.student-has-class.index',
            'admin.student-has-class.create',
            'admin.student-has-class.show',
            'admin.student-has-class.edit',
            'admin.student-has-class.delete',
            'admin.student-has-class.bulk-delete',
        ]);
