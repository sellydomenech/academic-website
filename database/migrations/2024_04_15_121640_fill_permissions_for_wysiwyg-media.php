...
class FillPermissionsForWysiwygMedia extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForWysiwygMedia constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.wysiwyg-media',
            'admin.wysiwyg-media.index',
            'admin.wysiwyg-media.create',
            'admin.wysiwyg-media.show',
            'admin.wysiwyg-media.edit',
            'admin.wysiwyg-media.delete',
            'admin.wysiwyg-media.bulk-delete',
        ]);
