...
class FillPermissionsForPersonalAccessToken extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPersonalAccessToken constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.personal-access-token.index',
            'admin.personal-access-token.create',
            'admin.personal-access-token.show',
            'admin.personal-access-token.edit',
            'admin.personal-access-token.delete',
            'admin.personal-access-token.bulk-delete',
        ]);
