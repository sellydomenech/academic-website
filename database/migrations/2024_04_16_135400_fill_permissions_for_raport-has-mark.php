...
class FillPermissionsForRaportHasMark extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRaportHasMark constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.raport-has-mark',
            'admin.raport-has-mark.index',
            'admin.raport-has-mark.create',
            'admin.raport-has-mark.show',
            'admin.raport-has-mark.edit',
            'admin.raport-has-mark.delete',
            'admin.raport-has-mark.bulk-delete',
        ]);
