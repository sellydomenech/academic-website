...
class FillPermissionsForClassGroup extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForClassGroup constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.class-group',
            'admin.class-group.index',
            'admin.class-group.create',
            'admin.class-group.show',
            'admin.class-group.edit',
            'admin.class-group.delete',
            'admin.class-group.bulk-delete',
        ]);
