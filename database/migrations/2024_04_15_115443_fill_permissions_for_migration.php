...
class FillPermissionsForMigration extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMigration constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.migration.show',
            'admin.migration.edit',
            'admin.migration.delete',
            'admin.migration.bulk-delete',
        ]);
