...
@section('title', trans('admin.raport.actions.index'))

@section('body')

    <raport-listing
        :data="{{ $data->toJson() }}"
        :url="'{{ url('admin/raports') }}'"
        inline-template>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> {{ trans('admin.raport.actions.index') }}
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/raports/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.raport.actions.create') }}</a>
                    </div>
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="{{ url('admin/raports/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.raport.actions.create') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
