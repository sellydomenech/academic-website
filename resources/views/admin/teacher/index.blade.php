                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'nik'">{{ trans('admin.teacher.columns.nik') }}</th>
                                        <th is='sortable' :column="'date_of_birth'">{{ trans('admin.teacher.columns.date_of_birth') }}</th>
                                        ...
                                        <th is='sortable' :column="'registration_date'">{{ trans('admin.teacher.columns.registration_date') }}</th>
