...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('class_id'), 'has-success': fields.class_id && fields.class_id.valid }">
    <label for="class_id" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.student.columns.class_id') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.class_id" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('class_id'), 'form-control-success': fields.class_id && fields.class_id.valid}" id="class_id" name="class_id" placeholder="{{ trans('admin.student.columns.class_id') }}">
        <div v-if="errors.has('class_id')" class="form-control-feedback form-text" v-cloak>@{{ errors.first('class_id') }}</div>
    </div>
</div>

<div class="form-group row align-items-center" :class="{'has-danger': errors.has('login_id'), 'has-success': fields.login_id && fields.login_id.valid }">
    <label for="login_id" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.student.columns.login_id') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.login_id" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('login_id'), 'form-control-success': fields.login_id && fields.login_id.valid}" id="login_id" name="login_id" placeholder="{{ trans('admin.student.columns.login_id') }}">
        <div v-if="errors.has('login_id')" class="form-control-feedback form-text" v-cloak>@{{ errors.first('login_id') }}</div>
    </div>
</div>
