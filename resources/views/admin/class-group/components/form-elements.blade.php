...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('teacher_id'), 'has-success': fields.teacher_id && fields.teacher_id.valid }">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <multiselect v-model="form.id" placeholder="{{ trans('brackets/admin-ui::admin.forms.select_options') }}" label="full_name"  track-by="id" :options="{{ $teachers->toJson() }}" :multiple="false" open-direction="bottom"></multiselect>
